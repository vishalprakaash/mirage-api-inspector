 ...
 * Returns `{ rules, idMap }`, where idMap resolves a Chrome rule id back to the
 * Mirage rule that produced it — one Mirage rule fans out to several Chrome
 * rules, so hit reporting needs the reverse lookup.
 */
